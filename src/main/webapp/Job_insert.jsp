...
<body>
	...
	<div class="row">
		<div class="col-lg-9 main-chart">
			<!-- input -->
			<form action="${pageContext.servletContext.contextPath}/job/add"
				 method="post">
				<div class="content-panel" style="margin-top: 100px;">
					<table class="table table-striped table-advance table-hover">
						<h4>
							<i class="fa fa-angle-right"></i> Insert JobInf
						</h4>
						<hr>
						<thead>
							<tr>
								<th><i class="fa fa-bullhorn"></i>职位名称</th>
								<th><i class="fa fa-bullhorn"></i>职位描述</th>
						...
						<tbody>
							<tr>
								<td>
									<input type="text" name="name" value="${registerJob.name}"/>
									<span>${name}</span>
								</td>
								<td>
									<input type="text" name="remark" value="${registerJob.remark}"/>
									<span>${remark}</span>
								</td>
								<td>
