		...
		<div class="col-lg-9 main-chart">
			...
			<div style="margin-top: 45px;">
				...
				<form id="form_query" class="form-inline" role="form"
					action="${pageContext.servletContext.contextPath}/dept/list">
					<div class="form-group">
						<label class="sr-only" for="exampleInputEmail2">Email
							address</label> <input type="text" class="form-control"
							id="exampleInputEmail2" placeholder="Department Name" name="name"
			...
			<div class="content-panel">
				<table class="table table-striped table-advance table-hover">
					...
					<thead>
						<tr>
							<th style="padding-left: 50px"><i class="fa fa-bullhorn"></i>部门</th>
							<th class="hidden-phone" style="padding-left: 50px"><i
								class="fa fa-question-circle"></i> 部门描述</th>
						</tr>
					</thead>
					<tbody>
						<!-- 遍历部门 -->
						<c:forEach items="${pageInfo.list}" var="DeptItem">
							<tr>
								<td style="padding-left: 50px">${DeptItem.name}</td>
								<td class="hidden-phone" style="padding-left: 50px">${DeptItem.remark}</td>
								<c:if test="${nowUser.status==1}">
									<td style="padding-left: 50px">
										<button class="btn btn-primary btn-xs">
											<a class="fa fa-pencil" style="color: white;"
												href="${pageContext.servletContext.contextPath}/dept/get?id=${DeptItem.id}">Update</a>
										</button>
										<button class="btn btn-danger btn-xs" onclick="">
											<a class="fa fa-trash-o" style="color: white;"
												href="${pageContext.servletContext.contextPath}/dept/delete?id=${DeptItem.id}">Delete</a>
										</button>
									</td>
								</c:if>
							</tr>
