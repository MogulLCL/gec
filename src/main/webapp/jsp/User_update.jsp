...
<body>
	...
	<div class="row">
		<div class="col-lg-9 main-chart">
			<!-- input -->
			<form action="${pageContext.servletContext.contextPath}/user/update"
				method="post">
						...
						<tbody>
							<tr>
								<td><input type="text" name="loginname"
									value="${updateUser.loginname}" /></td>
								<td class="hidden-phone"><input type="text"
									name="username" value="${updateUser.username}" /></td>
								<td><input type="text" name="status"
									value="${updateUser.status}" /></td>
								<td>
