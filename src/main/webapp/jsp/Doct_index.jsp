				...
				<ul class="dropdown-menu extended inbox">
					...
					<li><a href="index.html#">
							<span class="photo"><img
								alt="avatar"
								<c:if test="${nowUser!=null}">src="/photo/${nowUser.imgname}"</c:if>
								></span>
						<span class="subject">
							<span class="from">
								<c:if test="${nowUser!=null}">src="/photo/${nowUser.username}"</c:if>
							</span>
		...
		<div class="col-lg-9 main-chart">
			...
			<div style="margin-top: 45px;">
				...
				<form id="form_query" class="form-inline" role="form"
					action="${pageContext.servletContext.contextPath}/queryFileByName">
					<input id="page" name="pageNo" type="hidden" value="1" />
					<div class="form-group">
						<label class="sr-only" for="exampleInputEmail2">Email
							address</label> <input type="text" class="form-control"
							id="exampleInputEmail2" placeholder="File Name" name="filename"
					...
					<thead>
						<tr>
							...
							<th class="hidden-phone" style="padding-left:50px"><i class="fa fa-question-circle"></i>
								文件描述</th>
							<th style="padding-left:50px"><i class="fa fa-bullhorn"></i>上传时间</th>
							<th style="padding-left:50px"><i class="fa fa-bullhorn"></i>上传者</th>
							<th style="padding-left:50px"><i class="fa fa-bullhorn"></i>操作</th>
						</tr>
					</thead>
					<tbody>
						<!-- 遍历文件 -->
						<c:forEach items="${DoctList}" var="DoctItem">
							<tr>
								<td style="padding-left:50px">${DoctItem.filename}</td>
								<td style="padding-left:50px">${DoctItem.remark}</td>
								<td style="padding-left:50px">
									<fmt:formatDate value="${DoctItem.createdate}" pattern="yyyy-MM-dd HH:mm:ss"/>
								</td>
								<td style="padding-left:50px">${DoctItem.uploaduser}</td>
								<td style="padding-left:50px">
									<button class="btn btn-primary btn-xs">
										<a class="fa fa-pencil" style="color: white;" href="${pageContext.servletContext.contextPath}/DownloadDoct?Download_DoctName=${DoctItem.filename}">Download</a>
									</button>
									<c:if test="${nowUser.status==1}">
											<button class="btn btn-danger btn-xs" onclick="">
												<a class="fa fa-trash-o" style="color: white;" href="${pageContext.servletContext.contextPath}/DeleteDoct?Delete_Doctid=${DoctItem.id}&Delete_DoctName=${DoctItem.filename}">Delete</a>
											</button>
									</c:if>
								</td>
							</tr>
