    ...
    <!--main content start--> <section id="main-content"> <section
        ...
        <div class="row">
            <div class="col-lg-9 main-chart">
                <!-- input -->
                <form action="${pageContext.servletContext.contextPath}/upload/update"
                    ...
                    <div class="content-panel" style="margin-top: 100px;">
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <thead>
                            <tr>
                                <th><i class="fa fa-bullhorn"></i>备注</th>
                                <th><i class="fa fa-bookmark"></i> 文件</th>
                                <th><i class=" fa fa-edit"></i> 确认修改</th>
                                <th></th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                <td><input type="text" name="remark"
                                           value="${updateDocument.remark}" /></td>
