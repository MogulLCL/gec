...
<body>
	...
	<div class="row">
		<div class="col-lg-9 main-chart">
			<!-- input -->
			<form action="${pageContext.servletContext.contextPath}/employee/update"
				method="post">
					...
					<table class="table table-striped table-advance table-hover">
						...
						<thead>
							<tr>
								...
								<th><i class="fa fa-bookmark"></i>学历</th>
						...
						<tbody>
							<tr>
								<td><input type="text" name="name"
									value="${updateEmp.name}" /></td>
								<td class="hidden-phone"><input type="text" name="phone"
									value="${updateEmp.phone}" /></td>
								<td><select name="deptId">
										<c:forEach items="${deptSelectList}" var="deptSelectItem">
											<c:if test="${deptSelectItem.id==updateEmp.deptId}">
											<option selected value="${deptSelectItem.id}">${deptSelectItem.name}</option>
											</c:if>
											<c:if test="${deptSelectItem.id!=updateEmp.deptId}">
								...
								<td><select name="jobId">
										<c:forEach items="${jobSelectList}" var="jobSelectItem">
											<c:if test="${jobSelectItem.id==updateEmp.jobId}">
												<option selected value="${jobSelectItem.id}">${jobSelectItem.name}</option>
											</c:if>
											<c:if test="${jobSelectItem.id!=updateEmp.jobId}">
								...
								<td><input type="text" name="email"
									value="${updateEmp.email}" /></td>
								<td><input type="text" name="education"
									value="${updateEmp.education}" /></td>
								<td><input type="hidden" name="id" value="${updateEmp.id}" />
