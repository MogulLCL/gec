...
<body>
	...
	<div class="row">
		<div class="col-lg-9 main-chart">
			<!-- input -->
			<form action="${pageContext.servletContext.contextPath}/dept/update"
				method="post">
				<div class="content-panel" style="margin-top: 100px;">
					<table class="table table-striped table-advance table-hover">
						...
						<thead>
							<tr>
								<th><i class="fa fa-bullhorn"></i>部门</th>
						...
						<tbody>
							<tr>
								<td><input type="text" name="name"
									value="${updateDept.name}" /></td>
								<td class="hidden-phone"><input type="text" name="remark"
									value="${updateDept.remark}" /></td>
								<td><input type="hidden" name="id" value="${updateDept.id}" />
