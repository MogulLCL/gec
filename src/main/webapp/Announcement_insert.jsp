...
<body>
	...
	<div class="row">
		<div class="col-lg-9 main-chart">
			<!-- input -->
			<form
				action="${pageContext.servletContext.contextPath}/Announcement/add"
				class="bs-example bs-example-form" method="post">
				<div class="content-panel" style="margin-top: 100px;">
					<table class="table table-striped table-advance table-hover">
						<h4>
							<i class="fa fa-angle-right"></i> Insert Announcement
						</h4>
						<hr>
						<tbody>
							<tr>
								<td>
									<div class="input-group">
										<span class="input-group-addon">公告标题:</span> <input
											type="text" class="form-control" name="title"
											value="${registerAnnouncement.title}" /> <span>${title}</span>
									</div>
								</td>
							</tr>
							<tr>
								<td>
									<div class="input-group">
										<span class="input-group-addon">公告内容:</span> <input
											type="text" class="form-control" name="content"
											value="${registerAnnouncement.content}" /> <span>${content}</span>
									</div> <input type="hidden" class="form-control" name="uploader"
									value="${nowUser.id}" />
								</td>
							</tr>
							<tr>
