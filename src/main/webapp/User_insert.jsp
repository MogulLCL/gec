...
<body>
	...
	<div class="row">
		<div class="col-lg-9 main-chart">
			<!-- input -->
			<form action="${pageContext.servletContext.contextPath}/user/add"
				enctype="multipart/form-data" method="post">
				<div class="content-panel" style="margin-top: 100px;">
					<table class="table table-striped table-advance table-hover">
						<h4>
							<i class="fa fa-angle-right"></i> Insert UserInf
						</h4>
						<hr>
						<thead>
							<tr>
								<th><i class="fa fa-bullhorn"></i>登录名</th>
						...
						<tbody>
							<tr>
								<td><input type="text" name="loginname" /> <span>${loginname}</span>
								</td>
								<td><input type="text" name="password" /> <span>${password}</span>
								</td>
								<td class="hidden-phone"><input type="text" name="username" />
									<span>${username}</span></td>
								<td><input type="text" name="status" /> <span>${status}</span>
								</td>
