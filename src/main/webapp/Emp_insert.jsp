...
<body>
	...
	<div class="row">
		<div class="col-lg-9 main-chart">
			<!-- input -->
			<form action="${pageContext.servletContext.contextPath}/employee/add"
				enctype="multipart/form-data" method="post">
				<div class="content-panel" style="margin-top: 100px;">
					<table class="table table-striped table-advance table-hover">
						<h4>
							<i class="fa fa-angle-right"></i> Insert EmployeeInf
						</h4>
						<hr>
						<thead>
							<tr>
								<th><i class="fa fa-bullhorn"></i>员工名</th>
								<th><i class="fa fa-bullhorn"></i>密码</th>
								<th><i class="fa fa-bookmark"></i>身份证号</th>
								<th><i class=" fa fa-edit"></i>政治面貌</th>
								<th></th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td>
									<input type="text" name="name" value="${registerEmployee.name}"/>
									<span>${name}</span>
								</td>
								<td>
									<input type="text" name="password" value="${registerEmployee.password}"/>
									<span>${password}</span>
								</td>
								<td class="hidden-phone">
									<input type="text"
									name="cardId" value="${registerEmployee.cardId}"/>
									<span>${cardId}</span>
								</td>
								<td>
									<input type="text" name="party" value="${registerEmployee.party}"/>
									<span>${party}</span>
								</td>
							</tr>
						</tbody>
					...
					<table class="table table-striped table-advance table-hover">
						<thead>
							<tr>
								<th><i class="fa fa-bullhorn"></i>学历</th>
								<th><i class="fa fa-bullhorn"></i>民族</th>
						...
						<tbody>
							<tr>
								<td>
									<input type="text" name="education" value="${registerEmployee.education}"/>
									<span>${education}</span>
								</td>
								<td>
									<input type="text" name="race" value="${registerEmployee.race}"/>
									<span>${race}</span>
								</td>
								<td class="hidden-phone">
									<input type="text"
									name="phone" value="${registerEmployee.phone}"/>
									<span>${phone}</span>
								</td>
								<td>
									<input type="text" name="email" value="${registerEmployee.email}"/>
									<span>${email}</span>
								</td>
							</tr>
						</tbody>
					...
					<table class="table table-striped table-advance table-hover">
						<thead>
							<tr>
								...
								<th class="hidden-phone"><i class="fa fa-question-circle"></i>
									部门</th>
								<th><i class="fa fa-bookmark"></i> 职位</th>
								<th><i class="fa fa-bookmark"></i>头像</th>
						...
						<tbody>
							<tr>
								...
								<td>
									<select name="jobId">
									<c:forEach items="${jobSelectList}" var="jobSelectItem">
										<option value="${jobSelectItem.id}">${jobSelectItem.name}</option>
									</c:forEach>
									</select>
								</td>
