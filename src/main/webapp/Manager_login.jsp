	  	...
	  	<div class="container">
		      ...
		      <form class="form-login" action="${pageContext.servletContext.contextPath}/ManagerLogin" method="post">
		        ...
		        <div class="login-wrap">
		            <input type="text" class="form-control" name="loginname" placeholder="User ID" value="admin" autofocus>
		            <br>
					...
					<button class="btn btn-theme btn-block" type="button">
						<a class="fa fa-lock" href="${pageContext.servletContext.contextPath}/emp_login.jsp" style="color: white;">员工登录</a>
					</button>
		        </div>
