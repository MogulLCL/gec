            ...
            <div class="col-lg-9 main-chart">
                ...
                <div style="margin-top: 45px;">
                    ...
                    <form id="form_query" class="form-inline" role="form"
                          action="${pageContext.servletContext.contextPath}/upload/list">
                        <input id="page" name="pageNo" type="hidden" value="1" />
                        <div class="form-group">
                            <label class="sr-only" for="exampleInputEmail2">Email
                                address</label> <input type="text" class="form-control"
                                                       id="exampleInputEmail2" placeholder="User Name" name="filename"
                                                       value="${user.username}">
                        </div>
                ...
                <div class="content-panel">
                    <table class="table table-striped table-advance table-hover">
                        ...
                        <thead>
                        <tr>
                            <th style="padding-left:50px"><i class="fa fa-bullhorn"></i>文件名</th>
                            <th style="padding-left:50px"><i class="fa fa-bookmark"></i> 备注</th>
                            <th style="padding-left:50px"><i class=" fa fa-edit"></i> 创建时间</th>
                            <th style="padding-left:50px"><i class="fa fa-bullhorn"></i>上传者</th>
                            <th style="padding-left:50px"><i class=" fa fa-edit"></i> 操作</th>
                        </tr>
                        </thead>
                        <tbody>
                        <!-- 遍历用户 -->
                        <c:forEach items="${pageInfo.list}" var="documentItem">
                            <tr>
                                <td style="padding-left:50px">${documentItem.filename}</td>
                                <td class="hidden-phone" style="padding-left:50px">${documentItem.remark}</td>

                                <td style="padding-left:50px"><span class="label label-info label-mini"> <fmt:formatDate
                                        value="${documentItem.createDate}" pattern="yyyy-MM-dd HH:mm:ss" />
								</span></td>
                                <td style="padding-left:50px">${documentItem.username}</td>
                                <c:if test="${nowUser.status==1}">
                                    <td style="padding-left:50px">
                                        <button class="btn btn-primary btn-xs">
                                            <a class="fa fa-pencil" style="color: white;" href="${pageContext.servletContext.contextPath}/upload/get?id=${documentItem.id}">Update</a>
                                        </button>
                                        <button class="btn btn-danger btn-xs" onclick="">
                                            <a class="fa fa-trash-o" style="color: white;" href="${pageContext.servletContext.contextPath}/upload/delete?id=${documentItem.id}">Delete</a>
                                        </button>
                                        <button class="btn btn-primary btn-xs">
                                            <a class="fa fa-pencil" style="color: white;" href="${pageContext.servletContext.contextPath}/upload/dow?id=${documentItem.id}">下载</a>
                                        </button>
                                    </td>
                                </c:if>
                            </tr>
                    ...
                    <div class="desc">
                        ...
                        <div class="details">
                            <p>
                                ...
                                <muted>
                                    <c:if test="${member.status==1}">超级管理员</c:if>
                                    <c:if test="${member.status==0}">管理员</c:if>
                                </muted>
                            </p>
                        </div>
                    </div>
