		...
		<div class="col-lg-9 main-chart">
			...
			<div style="margin-top: 45px;">
				...
				<form id="form_query" class="form-inline" role="form"
					action="${pageContext.servletContext.contextPath}/employee/list">
			...
			<div class="content-panel">
				<table class="table table-striped table-advance table-hover">
					...
					<tbody>
						<!-- 遍历用户 -->
						<c:forEach items="${pageInfo.list}" var="employeeItem">
							<tr>
								<td>${employeeItem.name}</td>
								<td><c:if test="${employeeItem.sex==2}">男</c:if> <c:if
										test="${employeeItem.sex==1}">女</c:if></td>
								...
								<td><span class="label label-info label-mini"> <fmt:formatDate
											value="${employeeItem.createDate}"
										...
										<td style="padding-left: 50px">
											<button class="btn btn-primary btn-xs">
												<a class="fa fa-pencil" style="color: white;"
													href="${pageContext.servletContext.contextPath}/employee/get?id=${employeeItem.id}">Update</a>
											</button>
											<button class="btn btn-danger btn-xs" onclick="">
												<a class="fa fa-trash-o" style="color: white;"
													href="${pageContext.servletContext.contextPath}/employee/delete?id=${employeeItem.id}">Delete</a>
											</button>
										</td>
									</c:if>
								</c:if>
