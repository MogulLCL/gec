		...
		<div class="col-lg-9 main-chart">
			...
			<div style="margin-top: 45px;">
				...
				<form id="form_query" class="form-inline" role="form"
					action="${pageContext.servletContext.contextPath}/job/list">
					<input id="page" name="pageNo" type="hidden" value="1" />
					<div class="form-group">
						<label class="sr-only" for="exampleInputEmail2">Email
							address</label> <input type="text" class="form-control"
							id="exampleInputEmail2" placeholder="Job Name" name="name"
							value="${job.name}">
					</div>
			...
			<div class="content-panel">
				<table class="table table-striped table-advance table-hover">
					...
					<thead>
						<tr>
							<th style="padding-left:50px"><i class="fa fa-bullhorn"></i>职位</th>
					...
					<tbody>
						<!-- 遍历用户 -->
						<c:forEach items="${pageInfo.list}" var="jobItem">
							<tr>
								<td style="padding-left:50px">${jobItem.name}</td>
								<td class="hidden-phone" style="padding-left:50px">${jobItem.remark}</td>
								<c:if test="${nowUser.status==1}">
									<td style="padding-left:50px">
										<button class="btn btn-primary btn-xs">
											<a class="fa fa-pencil" style="color: white;" href="${pageContext.servletContext.contextPath}/job/get?id=${jobItem.id}">Update</a>
										</button>
										<button class="btn btn-danger btn-xs" onclick="">
											<a class="fa fa-trash-o" style="color: white;" href="${pageContext.servletContext.contextPath}/job/delete?id=${jobItem.id}">Delete</a>
										</button>
									</td>
								</c:if>
							</tr>
      ...
      *********************************************************************************************************************************************************** -->
		...
		<div class="col-lg-3 ds">
			...
			<c:if test="${nowEmployee!=null}">
				...
				<p>
					<img src="/photo/${nowEmployee.imgname}" class="img-circle" width="50">
				</p>
				<p>
			...
			<%-- <c:if test="${EmpTeamMembers!=null}">
			kong!!!!!!!!!
			</c:if> --%>
			<c:if test="${nowEmployee!=null}">
				<c:forEach items="${EmpTeamMembers}" var="member">
				<div class="desc">
				<div class="thumb">
					<img class="img-circle" src="/photo/${member.imgname}" width="35px"
						height="35px" align="">
				...
				<div class="details">
					<p>
						<span style="color: blue;font-size: 20px;">${member.name}</span><br />
						<muted>
							${member.party}
						</muted>
					</p>
