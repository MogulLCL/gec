			...
			<li id="header_inbox_bar" class="dropdown"><a
				...
				<ul class="dropdown-menu extended inbox">
					...
					<li><a href="index.html#"> <span class="photo"><img
								alt="avatar" src="assets/img/ui-divya.jpg"></span> <span class="subject"> <span
	...
	<div class="row">
		<div class="col-lg-9 main-chart">
			...
			<div style="margin-top: 45px;">
				<c:forEach items="${pageInfo.list}" var="announcementItem">
					<div class="content-panel">
						<table class="table table-striped table-advance table-hover">
							<h4>
								<i class="fa fa-angle-right"></i> ${announcementItem.title}
							</h4>
							<hr>
							<thead>
								<tr>
									<th style="padding-left: 50px"><i class="fa fa-bullhorn">内容：${announcementItem.content}</i></th>
								</tr>
							</thead>
							<tbody>
								<tr>
									...
									<td></td>
									<td></td>
									<td><fmt:formatDate value="${announcementItem.createtime}"
											pattern="yyyy-MM-dd hh:mm:ss" />
									<td>
<%--									<td>${announcementItem.uploader}</td>--%>
									<c:if test="${nowUser.status==1}">
										<td>
											<button class="btn btn-primary btn-xs">
												<a class="fa fa-pencil" style="color: white;"
													href="${pageContext.servletContext.contextPath}/Announcement/get?id=${announcementItem.id}">Update</a>
											</button>
											<button class="btn btn-danger btn-xs" onclick="">
												<a class="fa fa-trash-o" style="color: white;"
													href="${pageContext.servletContext.contextPath}/Announcement/delete?id=${announcementItem.id}">Delete</a>
											</button>
										</td>
									</c:if>
								</tr>
			...
			<form method="get" id="form_query"
				action="${pageContext.servletContext.contextPath}/Announcement/list">
		...
		<div class="col-lg-3 ds">
			...
			<c:if test="${nowUser!=null}">
				<c:forEach items="${teamMembers}" var="member">
					<div class="desc">
						<div class="thumb">
							<img class="img-circle" src="/photo/${member.imgname}"
