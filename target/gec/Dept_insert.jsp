...
<body>
	...
	<div class="row">
		<div class="col-lg-9 main-chart">
			<!-- input -->
			<form action="${pageContext.servletContext.contextPath}/dept/add"
				method="post">
				<div class="content-panel" style="margin-top: 100px;">
					<table class="table table-striped table-advance table-hover">
						<h4>
							<i class="fa fa-angle-right"></i> Insert DeptInf
						</h4>
						<hr>
						<thead>
							<tr>
								<th><i class="fa fa-bullhorn"></i>部门名称</th>
								<th><i class="fa fa-bullhorn"></i>部门描述</th>
						...
						<tbody>
							<tr>
								<td><input type="text" name="name"
									value="${registerDept.name}" /> <span>${name}</span></td>
								<td><input type="text" name="remark"
									value="${registerDept.remark}" /> <span>${remark}</span></td>
								<td>
